      ...
      body: Center(
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              children: [
                Image.asset("images/lock.png",width: wdth/3,height: hght/5,),
             Text("Forgot Password?",style: TextStyle(color: Colors.lightGreen,fontSize: 30,fontWeight: FontWeight.bold),),
                Container(
                  width: wdth/1.1,
                  child: Column(
                    children: [
